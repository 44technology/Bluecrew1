...
export default function ProjectsScreen() {
  ...
  const handleCreateProject = async () => {
    ...
    if (!newProject.project_street || !newProject.project_street.trim()) {
      ...
      errors.project_street = 'Street Address is required';
    }
    ...
    if (!newProject.project_zip || !newProject.project_zip.trim()) {
      ...
      errors.project_zip = 'ZIP Code is required';
    }
          ...
          <ScrollView style={styles.modalContent} showsVerticalScrollIndicator={false}>
            ...
            <View style={styles.inputGroup}>
              ...
              {Platform.OS === 'web' ? (
                <input
                  ...
                  style={{
                    width: '100%',
                    padding: '12px',
                    border: fieldErrors.start_date ? '1px solid #ef4444' : '1px solid #d1d5db',
                    borderRadius: '8px',
                    fontSize: '16px',
                    marginTop: '8px',
              ...
              {fieldErrors.start_date && (
                <Text style={styles.errorText}>{fieldErrors.start_date}</Text>
              )}
            </View>
            ...
            <View style={styles.inputGroup}>
              ...
              <TextInput
                ...
                onChangeText={(text) => {
                  ...
                  if (fieldErrors.project_street) {
                    setFieldErrors(prev => ({ ...prev, project_street: '' }));
                  }
                }}
              />
              {fieldErrors.project_street && (
                <Text style={styles.errorText}>{fieldErrors.project_street}</Text>
              )}
            </View>
            ...
            <View style={styles.inputGroup}>
              ...
              <TextInput
                ...
                onChangeText={(text) => {
                  ...
                  if (fieldErrors.project_city) {
                    setFieldErrors(prev => ({ ...prev, project_city: '' }));
                  }
                }}
              />
              {fieldErrors.project_city && (
                <Text style={styles.errorText}>{fieldErrors.project_city}</Text>
              )}
            </View>
            ...
            <View style={styles.inputGroup}>
              ...
              <TextInput
                ...
                onChangeText={(text) => {
                  ...
                  if (fieldErrors.project_state) {
                    setFieldErrors(prev => ({ ...prev, project_state: '' }));
                  }
                }}
              />
              {fieldErrors.project_state && (
                <Text style={styles.errorText}>{fieldErrors.project_state}</Text>
              )}
            </View>
            ...
            <View style={styles.inputGroup}>
              ...
              <TextInput
                ...
                onChangeText={(text) => {
                  ...
                  if (fieldErrors.project_zip) {
                    setFieldErrors(prev => ({ ...prev, project_zip: '' }));
                  }
                }}
                keyboardType="numeric"
              />
              {fieldErrors.project_zip && (
                <Text style={styles.errorText}>{fieldErrors.project_zip}</Text>
              )}
            </View>
