      ...
      >
        ...
        <View style={styles.monthlyContainer}>
          ...
          {loading ? (
            ...
            /* Table View (Desktop and Mobile with horizontal scroll) */
            <ScrollView
              horizontal={Dimensions.get('window').width < 768}
              showsHorizontalScrollIndicator={Dimensions.get('window').width < 768}
              contentContainerStyle={styles.tableScrollContent}
              style={Dimensions.get('window').width >= 768 ? { width: '100%' } : undefined}
            >
