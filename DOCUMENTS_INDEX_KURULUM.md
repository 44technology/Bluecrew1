# Documents Index Kurulum Rehberi

Project details > Documents sayfasında hata alınıyor. Firebase Firestore'da composite index gerekiyor.
...
✅ `firestore.indexes.json` dosyasına documents index'i eklendi
...
1. **Index'in oluşturulduğundan emin olun:**
   ...
   - `documents` collection'ında index'in "Enabled" olduğunu kontrol edin
...
3. ✅ Index'in "Enabled" durumuna gelmesini bekleyin
