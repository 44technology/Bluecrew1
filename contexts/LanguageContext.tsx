...
const translations = {
  en: {
    ...
    appName: 'BlueCrew Project Manager',
    aboutDescription: 'Professional construction project management and tracking application designed for BlueCrew Contractors.',
    // Tab / menu labels
    hr: 'HR',
    payroll: 'Payroll',
  ...
  es: {
    ...
    appName: 'BlueCrew Project Manager',
    aboutDescription: 'Aplicación profesional de gestión y seguimiento de proyectos de construcción para BlueCrew Contractors.',
    hr: 'RR. HH.',
    payroll: 'Nómina',
    commission: 'Comisión',
    leads: 'Leads',
